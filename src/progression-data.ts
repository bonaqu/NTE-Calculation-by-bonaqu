...
export const ascensionMaterials: Record<AscensionMaterialId, AscensionMaterialDefinition> = {
  beetleCoin: {
    ...
    name: { ru: 'Жук-монета', en: 'Beetle Coin' },
  ...
  lostWhispers: { id: 'lostWhispers', category: 'common', name: { ru: 'Потерянный шёпот', en: 'Lost Whispers' } },
  obscureWhispers: { id: 'obscureWhispers', category: 'common', name: { ru: 'Неясный шёпот', en: 'Obscure Whispers' } },
  paradoxicalWhispers: { id: 'paradoxicalWhispers', category: 'common', name: { ru: 'Парадоксальный шёпот', en: 'Paradoxical Whispers' } },
  fadingSilhouette: { id: 'fadingSilhouette', category: 'common', name: { ru: 'Исчезающий силуэт', en: 'Fading Silhouette' } },
  blurredSilhouette: { id: 'blurredSilhouette', category: 'common', name: { ru: 'Размытый силуэт', en: 'Blurred Silhouette' } },
  chaosSilhouette: { id: 'chaosSilhouette', category: 'common', name: { ru: 'Хаотичный силуэт', en: 'Chaos Silhouette' } },
  ...
  suspendedDelusions: { id: 'suspendedDelusions', category: 'common', name: { ru: 'Приостановленный бред', en: 'Suspended Delusions' } },
  yearningDelusions: { id: 'yearningDelusions', category: 'common', name: { ru: 'Страстный бред', en: 'Yearning Delusions' } },
  transcendentDelusions: { id: 'transcendentDelusions', category: 'common', name: { ru: 'Необыкновенный бред', en: 'Transcendent Delusions' } },
  chargingKnightSparkPlug: {
    id: 'chargingKnightSparkPlug', category: 'boss',
    name: { ru: 'Свеча зажигания атакующего рыцаря', en: 'Charging Knight Spark Plug' },
    farm: { ru: 'Охота на аномалию «Всадник без головы»', en: 'Anomaly Hunt "Headless Rider"' },
    originalFarmName: 'Headless Rider',
  },
  pageDelusionsShore: {
    id: 'pageDelusionsShore', category: 'boss',
    name: { ru: 'Страница с Брегов Заблуждений', en: "A Page from Delusion's Shore" },
    farm: { ru: 'Охота на аномалию «Чёрный том»', en: 'Anomaly Hunt "Black Tome"' },
    originalFarmName: 'Black Tome',
  },
  waterMoonPick: {
    id: 'waterMoonPick', category: 'boss',
    name: { ru: 'Пик Водяной Луны', en: 'Water Moon Pick' },
  ...
  nestGuardFragment: {
    ...
    farm: { ru: 'Охота на аномалию «Птица в гнезде»', en: 'Anomaly Hunt "Nestbound Bird"' },
    originalFarmName: 'Nestbound Bird',
  },
  colorfulTicketStub: {
    id: 'colorfulTicketStub', category: 'boss',
    name: { ru: 'Красочный обрывок билета', en: 'Colorful Ticket Stub' },
    farm: { ru: 'Охота на аномалию «Парусник»', en: 'Anomaly Hunt "Swallowtail"' },
  ...
  confessionalFlowerSeed: {
    ...
    name: { ru: 'Семя исповедального цветка', en: 'Confessional Flower Seed' },
...
export const progressionDatasetSources = [
  {
    ...
    verifiedAt,
    scope: {
      ru: 'Точная стоимость шести этапов прорыва и структура материалов на странице персонажа; эта же кривая сверена по страницам всех 20 доступных персонажей.',
  ...
  },
  {
    ...
    verifiedAt,
    scope: {
      ru: 'Сводная привязка семейств материалов, материалов с боссов и источников фарма; более новые персонажи дополнительно проверены по прямым страницам Icy Veins.',
