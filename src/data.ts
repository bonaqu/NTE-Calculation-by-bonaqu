...
export const arcBenchmarkScenarios: ArcBenchmarkScenario[] = [
  {
    ...
    rows: [
      ...
      { arcId: 'shiny-days-m5', percent: 91.88, note: { ru: 'Окно сломления сложно реализовать до гибели цели.', en: 'The Break window is difficult to realize before the target dies.' } },
  ...
  },
  {
    ...
    meta: [
      ...
      { ru: 'Вклад Ирой в урон команды: 10,51% без урона сломления', en: 'Iroi team damage contribution: 10.51% excluding Break DMG' },
    ],
    rows: [
      ...
      { arcId: 'shiny-days-m5', percent: 92.36, teamDamage: 2_496_268, teamDps: 71_322, note: { ru: 'Большинство боссов погибает до сломления.', en: 'Most bosses are dead before they break.' } },
